...
class SdCard {
 public:
  ...
  virtual void write_file(const char *path, const uint8_t *buffer, size_t len, const char *mode) { return; }
  ...
  virtual std::vector<uint8_t> read_file(char const *path) { return {}; };
